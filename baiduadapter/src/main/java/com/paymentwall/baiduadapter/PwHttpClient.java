...
public class PwHttpClient {
    public static final String BASE_URL = "https://api-trunk.s.stuffio.com/api/";
    public static final String GET_SIGNATURE_URL = BASE_URL + "pw-plus-plus/wechatpayments/signature";
    public static final int TIMEOUT_READ = 10000;
    public static final int TIMEOUT_CONNECT = 20000;
    private static String createOrderUrl = "http://bdwallet.duapp.com/createorder/pay_wap.php";

    public static void getSignature(Context context, final PsBaidu request, final Callback callback){
        Looper looper;
        if(context!=null) {
        ...
        Thread alipaySignThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL(GET_SIGNATURE_URL);
    ...
    public static void getOrderInfo(Context context, final Map<String, String> request, final Callback callback){
        Looper looper;
        if(context!=null) {
            looper = context.getMainLooper();
        } else {
