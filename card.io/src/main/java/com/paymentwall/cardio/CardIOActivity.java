...
import com.paymentwall.cardio.i18n.LocalizedStrings;
import com.paymentwall.cardio.i18n.StringKey;
import com.paymentwall.cardio.ui.ActivityHelper;
import com.paymentwall.cardio.ui.Appearance;
import com.paymentwall.cardio.ui.ViewUtil;
...
public final class CardIOActivity extends Activity {
     ...
     * with the camera.
     */
    public static final String EXTRA_NO_CAMERA = "com.paymentwall.cardio.noCamera";

    /**
     * Boolean extra. Optional. Defaults to <code>false</code>. If
     * set to <code>false</code>, expiry information will not be required.
     */
    public static final String EXTRA_REQUIRE_EXPIRY = "com.paymentwall.cardio.requireExpiry";
     ...
     */
    public static final String EXTRA_SCAN_EXPIRY = "com.paymentwall.cardio.scanExpiry";
     ...
     */
    public static final String EXTRA_UNBLUR_DIGITS = "com.paymentwall.cardio.unblurDigits";

    /**
     * Boolean extra. Optional. Defaults to <code>false</code>. If set, the user will be prompted
     * for the card CVV.
     */
    public static final String EXTRA_REQUIRE_CVV = "com.paymentwall.cardio.requireCVV";

    /**
     * Boolean extra. Optional. Defaults to <code>false</code>. If set, the user will be prompted
     * for the card billing postal code.
     */
    public static final String EXTRA_REQUIRE_POSTAL_CODE = "com.paymentwall.cardio.requirePostalCode";
     ...
     */
    public static final String EXTRA_RESTRICT_POSTAL_CODE_TO_NUMERIC_ONLY = "com.paymentwall.cardio.restrictPostalCodeToNumericOnly";

    /**
     * Boolean extra. Optional. Defaults to <code>false</code>. If set, the user will be prompted
     * for the cardholder name.
     */
    public static final String EXTRA_REQUIRE_CARDHOLDER_NAME = "com.paymentwall.cardio.requireCardholderName";

    /**
     * Boolean extra. Optional. Defaults to <code>false</code>. If set, the card.io logo will be
     * shown instead of the PayPal logo.
     */
    public static final String EXTRA_USE_CARDIO_LOGO = "com.paymentwall.cardio.useCardIOLogo";
     ...
     */
    public static final String EXTRA_SCAN_RESULT = "com.paymentwall.cardio.scanResult";

    /**
     * Boolean extra indicating card was not scanned.
     */
    private static final String EXTRA_MANUAL_ENTRY_RESULT = "com.paymentwall.cardio.manualEntryScanResult";
     ...
     */
    public static final String EXTRA_SUPPRESS_MANUAL_ENTRY = "com.paymentwall.cardio.suppressManual";
     ...
     */
    public static final String EXTRA_LANGUAGE_OR_LOCALE = "com.paymentwall.cardio.languageOrLocale";

    /**
     * Integer extra. Optional. Defaults to {@link Color#GREEN}. Changes the color of the guide overlay on the
     * camera.
     */
    public static final String EXTRA_GUIDE_COLOR = "com.paymentwall.cardio.guideColor";
     ...
     */
    public static final String EXTRA_SUPPRESS_CONFIRMATION = "com.paymentwall.cardio.suppressConfirmation";
     ...
     */
    public static final String EXTRA_HIDE_CARDIO_LOGO = "com.paymentwall.cardio.hideLogo";

    /**
     * String extra. Optional. Used to display instructions to the user while they are scanning
     * their card.
     */
    public static final String EXTRA_SCAN_INSTRUCTIONS = "com.paymentwall.cardio.scanInstructions";
     ...
     */
    public static final String EXTRA_SUPPRESS_SCAN = "com.paymentwall.cardio.suppressScan";
     ...
     */
    public static final String EXTRA_CAPTURED_CARD_IMAGE = "com.paymentwall.cardio.capturedCardImage";
     ...
     */
    public static final String EXTRA_RETURN_CARD_IMAGE = "com.paymentwall.cardio.returnCardImage";
     ...
     * resource.
     */
    public static final String EXTRA_SCAN_OVERLAY_LAYOUT_ID = "com.paymentwall.cardio.scanOverlayLayoutId";

    /**
     * Boolean extra. Optional. Use the PayPal icon in the ActionBar.
     */
    public static final String EXTRA_USE_PAYPAL_ACTIONBAR_ICON =
            "com.paymentwall.cardio.intentSenderIsPayPal";
     ...
     */
    public static final String EXTRA_KEEP_APPLICATION_THEME = "com.paymentwall.cardio.keepApplicationTheme";


    /**
     * Boolean extra. Used for testing only.
     */
    static final String PRIVATE_EXTRA_CAMERA_BYPASS_TEST_MODE = "com.paymentwall.cardio.cameraBypassTestMode";
    ...
    private static final String BUNDLE_WAITING_FOR_PERMISSION = "com.paymentwall.cardio.waitingForPermission";
    ...
    private void showCameraScannerOverlay() {
        ...
        try {
            ...
            if (getIntent().getBooleanExtra(PRIVATE_EXTRA_CAMERA_BYPASS_TEST_MODE, false)) {
                ...
                // builds.
                Class<?> testScannerClass = Class.forName("com.paymentwall.cardio.CardScannerTester");
    ...
    public static String sdkVersion() {
        return com.paymentwall.cardio.BuildConfig.PRODUCT_VERSION;
    }
    ...
    public static Date sdkBuildDate() {
        return new Date(com.paymentwall.cardio.BuildConfig.BUILD_TIME);
    }
...
//            mOverlay.setTorchOn(b);
            if (b) {
                ivTorch.setImageResource(com.paymentwall.cardio.R.drawable.ic_flash);
            } else {
                ivTorch.setImageResource(com.paymentwall.cardio.R.drawable.ic_flash_off);
            }
        }
    }
    ...
    private void setPreviewLayout() {
        ...
        mMainLayout.setBackgroundColor(getResources().getColor(com.paymentwall.cardio.R.color.bg_scan_card));
        mMainLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));
        ...
        if (getIntent() != null) {
            ...
            if (color != 0) {
                ...
                // default to greeeeeen
                mOverlay.setGuideColor(getResources().getColor(com.paymentwall.cardio.R.color.scan_frame));
            }
...
//            boolean hideCardIOLogo = getIntent().getBooleanExtra(EXTRA_HIDE_CARDIO_LOGO, false);
        ...
        ivTorch = new ImageView(this);
        RelativeLayout.LayoutParams torchParams = new RelativeLayout.LayoutParams((int) PwUtils.dpToPx(this, 20), (int) PwUtils.dpToPx(this, 29));
        torchParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        torchParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        torchParams.setMargins(0, (int) PwUtils.dpToPx(this, 16), (int) PwUtils.dpToPx(this, 16), 0);
        ivTorch.setLayoutParams(torchParams);
        ivTorch.setPadding((int) PwUtils.dpToPx(this, 4), (int) PwUtils.dpToPx(this, 4), (int) PwUtils.dpToPx(this, 4), (int) PwUtils.dpToPx(this, 4));
        ivTorch.setImageResource(com.paymentwall.cardio.R.drawable.ic_flash_off);
        mMainLayout.addView(ivTorch);
        ...
        ProximaNovaRegularTextView tvEnterManually = new ProximaNovaRegularTextView(this);
        tvEnterManually.setTextSize(16);
        tvEnterManually.setTextColor(Color.WHITE);
        tvEnterManually.setAllCaps(true);
        tvEnterManually.setText(getString(com.paymentwall.cardio.R.string.enter_manually));
        RelativeLayout.LayoutParams enterParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        enterParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        enterParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        enterParams.setMargins(0, 0, (int) PwUtils.dpToPx(this, 16), (int) PwUtils.dpToPx(this, 16));
        mMainLayout.addView(tvEnterManually, enterParams);
        tvEnterManually.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
