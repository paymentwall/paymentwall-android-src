...
//            mOverlay.setTorchOn(b);
            if (b) {
                ivTorch.setImageResource(R.drawable.ic_flash);
            } else {
    ...
    private void setPreviewLayout() {
        ...
        mMainLayout.setBackgroundColor(getResources().getColor(R.color.bg_scan_card));
        mMainLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));
        ...
        if (getIntent() != null) {
            ...
            if (color != 0) {
                ...
                // default to greeeeeen
                mOverlay.setGuideColor(getResources().getColor(R.color.scan_frame));
            }
...
//            boolean hideCardIOLogo = getIntent().getBooleanExtra(EXTRA_HIDE_CARDIO_LOGO, false);
        ...
        tvEnterManually.setText(getString(R.string.enter_manually));
