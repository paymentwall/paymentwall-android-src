...
public class PwlHttpClient {

    public static final String BASE_URL = "https://api-trunk.s.stuffio.com/api/";
    public static final String GET_SIGNATURE_URL = BASE_URL + "pw-plus-plus/unionpay/signature";
    public static final int TIMEOUT_READ = 10000;
    public static final int TIMEOUT_CONNECT = 20000;

    public static void getSignature(Context context, final PsMol request, final Callback callback){
        Looper looper;
        if(context!=null) {
