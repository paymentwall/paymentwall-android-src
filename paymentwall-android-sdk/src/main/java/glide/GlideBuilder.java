...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link glide.load.engine.cache.MemoryCache} implementation to store
   * {@link glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link glide.load.engine.cache.DiskCache} implementation to use to store
   * {@link glide.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(glide.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link glide.load.engine.cache.DiskCache} to use to store {@link
   * glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link glide.load.engine.Resource}s that are not already in the cache.
   *
   * <p> Any implementation must order requests based on their {@link glide.Priority}
  ...
  /**
   * Sets the {@link java.util.concurrent.ExecutorService} implementation to use when retrieving
   * {@link glide.load.engine.Resource}s that are currently in cache.
   *
   * <p> Any implementation must order requests based on their {@link glide.Priority}
   * for thumbnail requests to work properly.
   *
   ...
   * RequestBuilder#apply(glide.request.BaseRequestOptions)} will override defaults
   * set here.
   *
  ...
  /**
   * Sets the {@link glide.load.DecodeFormat} that will be the default format for all
   ...
   * glide.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link glide.manager.ConnectivityMonitorFactory}
   * to use to notify {@link glide.RequestManager} of connectivity events.
   * If not set {@link glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
