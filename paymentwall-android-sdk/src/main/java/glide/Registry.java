...
import glide.load.data.DataRewinderRegistry;
import glide.load.engine.DecodePath;
import glide.load.engine.LoadPath;
import glide.load.engine.Resource;
import glide.load.model.ModelLoader;
import glide.load.model.ModelLoaderFactory;
import glide.load.model.ModelLoaderRegistry;
import glide.load.resource.transcode.ResourceTranscoder;
import glide.load.resource.transcode.TranscoderRegistry;
import glide.provider.EncoderRegistry;
import glide.provider.LoadPathCache;
import glide.provider.ModelToResourceClassCache;
import glide.provider.ResourceDecoderRegistry;
import glide.provider.ResourceEncoderRegistry;
...
public class Registry {
  ...
  /**
   * Use the given factory to build a {@link glide.load.model.ModelLoader} for models
  ...
  /**
   * Thrown when no {@link glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
