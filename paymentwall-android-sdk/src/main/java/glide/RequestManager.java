...
import static glide.request.RequestOptions.decodeTypeOf;
import static glide.request.RequestOptions.diskCacheStrategyOf;
import static glide.request.RequestOptions.skipMemoryCacheOf;
...
import glide.request.target.ViewTarget;
...
public class RequestManager implements LifecycleListener {
   ...
   * glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link glide.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
   ...
   * {@link glide.load.ResourceDecoder}s
