 ...
 * {@link android.graphics.Bitmap}s returned by {@link glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link glide.load.ResourceDecoder}.
