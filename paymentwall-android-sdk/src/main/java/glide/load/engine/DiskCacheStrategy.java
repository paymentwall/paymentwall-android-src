...
public abstract class DiskCacheStrategy {
   ...
   * {@link glide.load.data.DataFetcher} and the
   * {@link glide.load.EncodeStrategy} of the
   * {@link glide.load.ResourceEncoder} (if an
   * {@link glide.load.ResourceEncoder} is available).
   */
   ...
   * glide.load.ResourceEncoder} will use to encode the resource.
   */
