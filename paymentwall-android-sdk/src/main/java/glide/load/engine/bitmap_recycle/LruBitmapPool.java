package glide.load.engine.bitmap_recycle;
...
/**
 * An {@link glide.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link glide.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
