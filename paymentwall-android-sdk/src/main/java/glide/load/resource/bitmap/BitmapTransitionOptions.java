...
import glide.TransitionOptions;
import glide.request.transition.BitmapTransitionFactory;
import glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see glide.GenericTransitionOptions#with(TransitionFactory)
   */
   ...
   * @see glide.request.transition.DrawableCrossFadeFactory.Builder
   */
