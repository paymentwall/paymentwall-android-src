...
import glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link glide.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("glide.load.resource.bitmap.Downsampler.DownsampleStrategy",
   ...
   * provided  {@link glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
