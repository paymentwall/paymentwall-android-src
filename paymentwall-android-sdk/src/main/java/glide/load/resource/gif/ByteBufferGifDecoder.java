...
import glide.load.resource.bitmap.ImageHeaderParser.ImageType;
...
/**
 * An {@link glide.load.ResourceDecoder} that decodes {@link
 * glide.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
  ...
  public static final Option<Boolean> DISABLE_ANIMATION = Option.memory(
      "glide.load.resource.gif.ByteBufferGifDecoder.DisableAnimation", false);
