...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link glide.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link glide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(glide.load.Transformation, Bitmap)
   */
