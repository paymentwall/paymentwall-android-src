...
/**
 * A class that allows {@link glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
