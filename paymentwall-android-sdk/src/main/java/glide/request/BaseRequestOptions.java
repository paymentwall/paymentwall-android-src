...
import glide.load.resource.bitmap.CircleCrop;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link glide.request.target.Target}'s size before
   ...
   *                       {@link glide.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link glide.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link glide.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link glide.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link glide.load.engine.DiskCacheStrategy#DATA} or
   * {@link glide.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link glide.request.target.Target}'s width and height with the
   ...
   *
   * @param signature A unique non-null {@link glide.load.Key} representing the current
   *                  state of the model that will be mixed in to the cache key.
   * @return This request builder.
   * @see glide.signature.ObjectKey
   */
   ...
   * {@link glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Sets the value for key
   * {@link glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_QUALITY}.
   */
  ...
  /**
   * Applies {@link glide.load.resource.bitmap.CenterCrop} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context Any {@link Context}.
   * @see #optionalTransform(Class, glide.load.Transformation)
   ...
   *
   * @param context Any {@link Context}.
   * @see #transform(Class, glide.load.Transformation)
  ...
  /**
   * Applies {@link glide.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link glide.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies the given {@link glide.load.Transformation} for
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link glide.load.resource.gif.GifDrawable})
   * and throws an exception if asked to transform an unknown type.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link glide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #optionalTransform(Context, glide.load.Transformation)
   * @see #optionalTransform(Class, glide.load.Transformation)
   */
   ...
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link glide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #transform(Context, glide.load.Transformation)
   * @see #transform(Class, glide.load.Transformation)
   */
  ...
  /**
   * Applies the given {@link glide.load.Transformation} for any decoded resource of
   ...
   * {@link glide.load.Transformation} for a resource type that already has a
   * {@link glide.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link glide.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link glide.load.Transformation Transformations} for all
   ...
   * {@link glide.TransitionOptions#dontTransition()}</p>
   */
