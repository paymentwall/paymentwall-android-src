...
/**
 * The standard concrete implementation of {@link glide.request.BaseRequestOptions}.
 *
 * <p> Uses with custom types, transformations, or options can subclass and customize. {@link
 * glide.request.BaseRequestOptions}. </p>
 */
...
public final class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link glide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link glide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
