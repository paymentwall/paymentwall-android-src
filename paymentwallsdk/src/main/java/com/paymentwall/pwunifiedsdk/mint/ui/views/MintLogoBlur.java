...
/**
 * Created by hoahieu on 29/02/16.
 */
public class MintLogoBlur extends View {
    public static final long DURATION_DEFAULT = 2000; //2000ms
    ...
    public MintLogoBlur(Context context) {
        super(context);
        init();
    }

    public MintLogoBlur(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MintLogoBlur(Context context, AttributeSet attrs, int defStyleAttr) {
