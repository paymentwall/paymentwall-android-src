...
public class ProgressWheel extends View {
    ...
    //Sizes (with defaults)
    private int layout_height = LayoutParams.WRAP_CONTENT;
    private int layout_width = LayoutParams.WRAP_CONTENT;
    ...
    private float contourSize = 2.0f;
    ...
    private int barColor = 0xAAffffff;
    private int contourColor = 0xAAffffff;
    private int circleColor = 0x00000000;
    private int rimColor = 0xAAff00ff;
