...
import static glide.request.RequestOptions.signatureOf;
...
import glide.request.FutureTarget;
import glide.request.Request;
import glide.request.RequestCoordinator;
import glide.request.RequestFutureTarget;
import glide.request.RequestListener;
import glide.request.RequestOptions;
import glide.request.SingleRequest;
import glide.request.ThumbnailRequestCoordinator;
import glide.request.target.PreloadTarget;
import glide.request.target.Target;
import glide.signature.ApplicationVersionSignature;
import glide.signature.ObjectKey;
 ...
 * {@link glide.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
   ...
   * glide.load.model.ModelLoader}, {@link glide.load.ResourceDecoder},
   * and {@link glide.load.Transformation}s. However,
   * {@link glide.request.BaseRequestOptions#placeholder(int)} and
   * {@link glide.request.BaseRequestOptions#error(int)}, and
   ...
   * {@link #into(glide.request.target.Target)} is called. </p>
   *
   ...
   * {@link glide.request.BaseRequestOptions#signature(glide.load.Key)} to
   ...
   * {@link glide.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link glide.request.BaseRequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link glide.load.model.UriLoader}.
   */
   ...
   * {@link glide.request.BaseRequestOptions#signature(glide.load.Key)}
   ...
   * the {@link glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link glide.load.engine.DiskCacheStrategy#NONE} via
   * {@link BaseRequestOptions#diskCacheStrategy(glide.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
   *
   * @see #load(Integer)
   * @see glide.signature.ApplicationVersionSignature
   */
   ...
   * @return The
   * {@link glide.request.target.Target} used to wrap the given {@link ImageView}.
   */
   ...
   *               overridden by
   *               {@link glide.request.BaseRequestOptions#override(int, int)} if
   *               previously called.
