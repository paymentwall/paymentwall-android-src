...
public final class MemorySizeCalculator {
  ...
  public static final class Builder {
     ...
     * {@link glide.load.engine.cache.MemoryCache} should be able to hold and
    ...
    /**
     * Sets the number of device screens worth of pixels the
     * {@link glide.load.engine.bitmap_recycle.BitmapPool} should be able to hold and
     * returns this Builder.
     */
     ...
     * taken up by Glide's {@link glide.load.engine.cache.MemoryCache} and
     * {@link glide.load.engine.bitmap_recycle.BitmapPool} put together, and returns
     * this builder.
     */
     ...
     * glide.load.engine.bitmap_recycle.ArrayPool} to use to store temporary
