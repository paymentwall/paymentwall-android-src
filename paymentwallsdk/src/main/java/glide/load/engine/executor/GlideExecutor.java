package glide.load.engine.executor;
...
public final class GlideExecutor extends ThreadPoolExecutor {
   ...
   * prefix, and the
   * {@link glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * and {@link glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   ...
   * glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
  ...
  public static int calculateBestThreadCount() {
    ...
    // See: https://github.glide/issues/1170
