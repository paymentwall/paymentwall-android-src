package glide.load.model.stream;

import android.support.annotation.Nullable;
import glide.load.Option;
import glide.load.Options;
import glide.load.data.HttpUrlFetcher;
import glide.load.model.GlideUrl;
import glide.load.model.ModelCache;
import glide.load.model.ModelLoader;
import glide.load.model.ModelLoaderFactory;
import glide.load.model.MultiModelLoaderFactory;
import java.io.InputStream;

/**
 * An {@link glide.load.model.ModelLoader} for translating {@link
 * glide.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT = Option.memory(
      "glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
