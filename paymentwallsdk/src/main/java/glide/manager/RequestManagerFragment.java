 ...
 * glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see glide.manager.SupportRequestManagerFragment
 * @see glide.manager.RequestManagerRetriever
 * @see glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link glide.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link glide.RequestManager} or null if none exists.
   */
  @Nullable
