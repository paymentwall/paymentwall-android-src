 ...
 * {@link glide.GlideBuilder} and registering
 * {@link glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, glide.load.ResourceDecoder)} for each
 * {@link glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="glide.samples.flickr.FlickrGlideModule"
...
public interface GlideModule {
  ...
  /**
   * Lazily apply options to a {@link glide.GlideBuilder} immediately before the Glide
   * singleton is created.
   *
   * <p> This method will be called once and only once per implementation. </p>
   *
   * @param context An Application {@link Context}.
   * @param builder The {@link glide.GlideBuilder} that will be used to create Glide.
   */
   ...
   *
   * @param context  An Application {@link Context}.
   * @param registry An {@link glide.Registry} to use to register components.
   */
