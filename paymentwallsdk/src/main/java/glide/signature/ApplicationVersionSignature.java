...
/**
 * A utility class for obtaining a {@link glide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link glide.load.Key} for version code of the Application
