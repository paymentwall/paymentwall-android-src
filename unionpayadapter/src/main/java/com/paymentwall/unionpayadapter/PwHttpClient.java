...
public class PwHttpClient {
    ...
    public static final String URL_STAGING = "https://api-trunk.s.stuffio.com/api/pw-plus-plus/unionpay/signature";
    public static final String URL_PRODUCTION = "https://api.paymentwall.com/api/pw-plus-plus/unionpay/signature";
